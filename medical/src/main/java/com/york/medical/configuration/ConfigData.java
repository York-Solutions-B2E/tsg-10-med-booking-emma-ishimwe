        ...
        public CommandLineRunner commandLineRunner(
                ...
                return args -> {
                        ...
                        List<Patient> patients = List.of(
                                        new Patient("Alice", "Johnson", LocalDate.of(1990, 1, 10),
                                                        "alice.johnson@example.com"),
                                        new Patient("Bob", "Williams", LocalDate.of(1985, 5, 15),
                                                        "bob.williams@example.com"),
                                        new Patient("Charlie", "Jones", LocalDate.of(1992, 8, 20),
                                                        "charlie.jones@example.com"),
                                        new Patient("Diana", "Miller", LocalDate.of(1980, 12, 25),
                                                        "diana.miller@example.com"),
                                        new Patient("Ethan", "Taylor", LocalDate.of(1995, 3, 30),
                                                        "ethan.taylor@example.com"),
                                        new Patient("Fiona", "Clark", LocalDate.of(1988, 7, 5),
                                                        "fiona.clark@example.com"),
                                        new Patient("George", "Lopez", LocalDate.of(1991, 9, 12),
                                                        "george.lopez@example.com"),
                                        new Patient("Hannah", "Hill", LocalDate.of(1993, 11, 18),
                                                        "hannah.hill@example.com"),
                                        new Patient("Isaac", "Scott", LocalDate.of(1984, 6, 22),
                                                        "isaac.scott@example.com"),
                                        new Patient("Julia", "Adams", LocalDate.of(1997, 4, 8),
                                                        "julia.adams@example.com"));
                        patientRepository.saveAll(patients);

                        // Create Appointments
                        List<Appointment> appointments = List.of(
                                        new Appointment(doctors.get(0), patients.get(0),
                                                        LocalDateTime.of(2024, 12, 15, 10, 0), VisitType.IN_PERSON,
                                                        AppointmentStatus.CONFIRMED),
                                        new Appointment(doctors.get(1), patients.get(1),
                                                        LocalDateTime.of(2024, 12, 16, 14, 30), VisitType.TELEHEALTH,
                                                        AppointmentStatus.PENDING),
                                        new Appointment(doctors.get(2), patients.get(2),
                                                        LocalDateTime.of(2024, 12, 17, 9, 0), VisitType.IN_PERSON,
                                                        AppointmentStatus.CONFIRMED));
