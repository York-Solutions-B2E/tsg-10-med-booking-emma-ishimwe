...
public class AuthController {
    ...
    // This mapping is needed because if you set the success url in the security
    // config to
    // localhost:3000 the CSRF token will not be set properly.
    // You will NOT be able to log out (CSRF Token is necessary to make POST
    ...
    // Route to provide user data to the frontend - useful to manage role-based
    // access for react-router-dom routes
    @GetMapping("/api/user")
    ...
    public ResponseEntity<?> logout(HttpServletRequest request,
        ...
        // Build the logout details (end session endpoint and id token) to send to the
        // client
